...
_TENSORPROTO = _descriptor.Descriptor(
  name='TensorProto',
  full_name='ml_serving.TensorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dtype', full_name='ml_serving.TensorProto.dtype', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='ml_serving.TensorProto.tensor_shape', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version_number', full_name='ml_serving.TensorProto.version_number', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensor_content', full_name='ml_serving.TensorProto.tensor_content', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='half_val', full_name='ml_serving.TensorProto.half_val', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='float_val', full_name='ml_serving.TensorProto.float_val', index=5,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='double_val', full_name='ml_serving.TensorProto.double_val', index=6,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int_val', full_name='ml_serving.TensorProto.int_val', index=7,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='string_val', full_name='ml_serving.TensorProto.string_val', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scomplex_val', full_name='ml_serving.TensorProto.scomplex_val', index=9,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int64_val', full_name='ml_serving.TensorProto.int64_val', index=10,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool_val', full_name='ml_serving.TensorProto.bool_val', index=11,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dcomplex_val', full_name='ml_serving.TensorProto.dcomplex_val', index=12,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resource_handle_val', full_name='ml_serving.TensorProto.resource_handle_val', index=13,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='variant_val', full_name='ml_serving.TensorProto.variant_val', index=14,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uint32_val', full_name='ml_serving.TensorProto.uint32_val', index=15,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uint64_val', full_name='ml_serving.TensorProto.uint64_val', index=16,
...
_VARIANTTENSORDATAPROTO = _descriptor.Descriptor(
  ...
  full_name='ml_serving.VariantTensorDataProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type_name', full_name='ml_serving.VariantTensorDataProto.type_name', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='ml_serving.VariantTensorDataProto.metadata', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tensors', full_name='ml_serving.VariantTensorDataProto.tensors', index=2,
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:ml_serving.TensorProto)
  ))
...
VariantTensorDataProto = _reflection.GeneratedProtocolMessageType('VariantTensorDataProto', (_message.Message,), dict(
  ...
  __module__ = 'tensor_pb2'
  # @@protoc_insertion_point(class_scope:ml_serving.VariantTensorDataProto)
  ))
