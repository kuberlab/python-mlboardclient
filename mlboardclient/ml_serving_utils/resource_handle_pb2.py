...
_RESOURCEHANDLEPROTO = _descriptor.Descriptor(
  ...
  full_name='ml_serving.ResourceHandleProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='device', full_name='ml_serving.ResourceHandleProto.device', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='container', full_name='ml_serving.ResourceHandleProto.container', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='ml_serving.ResourceHandleProto.name', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash_code', full_name='ml_serving.ResourceHandleProto.hash_code', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maybe_type_name', full_name='ml_serving.ResourceHandleProto.maybe_type_name', index=4,
...
ResourceHandleProto = _reflection.GeneratedProtocolMessageType('ResourceHandleProto', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:ml_serving.ResourceHandleProto)
  ))
